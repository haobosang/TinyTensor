...
namespace TinyTensor
{
    ...
    )
    {
        ...
        {
            this->bias_.at(i) = std::make_shared<Tensor<float>>(param_channel, param_height, param_width);
        }
    }
    ...
    )
    {
        ...
        for (uint32_t i = 0; i < param_count; ++i)
        {
            this->weights_.at(i) = std::make_shared<Tensor<float>>(param_channel, param_height, param_width);
        }
    }
