...
TEST(test_layer, forward_sigmoid) {
    ...
    ASSERT_EQ(outputs.at(i)->index(0), 1 / (1 + std::exp(outputs.at(i)->index(0))));
    ASSERT_EQ(outputs.at(i)->index(1), 1 / (1 + std::exp(outputs.at(i)->index(1))));
    ASSERT_EQ(outputs.at(i)->index(2), 1 / (1 + std::exp(outputs.at(i)->index(2))));
    }
